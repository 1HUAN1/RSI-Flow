...
class PipelineConfig(BaseModel):
    ...
    task_update_policy: Literal['always_apply', 'sequential_positive_gain', 'legal_single_update_then_measure'] = 'always_apply'
...
def _run(config, run_dir, *, resume=False):
    ...
    if config.task_update_policy in {'sequential_positive_gain','legal_single_update_then_measure'}:
...
def freeze(run_dir):
    ...
    sequential = final.get('task_update_policy') in {'sequential_same_parent_first_positive_v1','legal_single_update_then_measure'}
