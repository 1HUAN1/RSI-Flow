...
def main():
    ...
    if benchmark=='bfcl_v3':
        ...
        categories=spec.get('categories') or [spec['category']]
        for category in categories:
            ACE_DATA_CATEGORY.setdefault(category,[category])
        ...
        sys.argv=[script,'--model',alias,'--category',*categories,'--language',spec['language'],'--output-dir',output]
