...
"""
    ...
    first = backend.prepare(
        "This synthetic compatibility fixture is fully specified here; meta_input/operation.json and meta_input/G are not staged. "
    ...
    try:
        ...
        second = backend.prepare("This synthetic fixture has no meta_input/operation.json or meta_input/G. "
            "Read AGENTS.md using a Codex tool, extract its Compatibility reload marker, "
            "and return that marker, answer=5 and test_passed=true. Do not modify inputs; "
            "write only the required .meta_candidate.json result envelope when candidate-file delivery is enabled.",
