...
def experience_summary(experience) -> dict:
    ...
    return {"generation": experience.generation, "experience_id": experience.experience_id,
            ...
            "candidate_attempts": [{key: attempt.get(key) for key in
                ("attempt_id", "action", "status", "gain", "positive_gain", "accepted_for_deployment",
                 "candidate_executed", "outcome_class", "reason", "paired_outcome")}
            ...
            "attempted_component": experience.attempted_component,
            "attempted_state_after": experience.attempted_state_after,
            "attempted_intervention_diff": experience.attempted_intervention_diff,
            "attempted_performance_after": experience.attempted_performance_after,
            "attempted_performance_delta": experience.attempted_performance_delta,
            "attempted_cost_after": experience.attempted_cost_after,
            "attempted_trajectory_after": experience.attempted_trajectory_after,
            "attempted_outcome": experience.attempted_outcome,
